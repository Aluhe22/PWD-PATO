...
<form class="needs-validation" novalidate id="from_horarios" name="from_horarios" method="post" action="ejercicio_2_resultado.php">
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="lunes_hs" name="lunes_hs"  required>
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="martes_hs" name="martes_hs" required >
        <div class="invalid-feedback">
                Debe por lo menos poner 0 si no tiene Clases!
        </div>
        <div class="valid-feedback">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="miercoles_hs" name="miercoles_hs" required>
        <div class="invalid-feedback">
                Debe por lo menos poner 0 si no tiene Clases!
        </div>
        <div class="valid-feedback">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="jueves_hs" name="jueves_hs" required >
        <div class="invalid-feedback">
                Debe por lo menos poner 0 si no tiene Clases!
        </div>
        <div class="valid-feedback">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="viernes_hs" name="viernes_hs" required >
        <div class="invalid-feedback">
                Debe por lo menos poner 0 si no tiene Clases!
        </div>
        <div class="valid-feedback">
